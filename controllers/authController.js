...
const protect = catchAsync( async(req , res , next)=>{
    ...
    if(currentUser.changedPasswordAfter(decoded.iat)){
        return next(new AppError('User currently changed password! please log in again' , 401));
    };
...
export {signup , login , logout , protect , restrictTo , forgotPassword , resetPassword , updatePassword};